...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/motelTEAM/Files_motel/master/File_Bot/commands.lua") 
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/motelTEAM/Files_motel/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/motelTEAM/Files_motel/master/File_Bot/"..file)
if res == 200 then
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'موتيل').." غادر" or text == 'غادر' then  
...
zh = https.request('https://rudi-dev.tk/Amir1/motel.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
gk = https.request('https://rudi-dev.tk/Amir2/motel.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/motel.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
