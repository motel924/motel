...
sudo_users = {SUDO,833156404,16076569}   
...
if DevHeDo(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SRC-motel/Files_motel/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SRC-motel/Files_motel/main/File_Bot/"..file)
if res == 200 then
