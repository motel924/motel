...
{{text = '⋄︙SoUrCe motel.', url="t.me/o_vv_vv"}},
}
...
send(msg.chat_id_,0, "⋄︙عذرا يا » {["..data.first_name_.."](t.me/o_vv_vv)}\n⋄︙الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard.inline_keyboard = {
{
{text = '⋄ معرفة المزيد ؟',url="https://t.me/o_vv_vv"},
},
}
local msg_id = msg.id_/2097152/0.5
...
⋄︙[𝘊𝘜𝘒𝘜𝘙 𝘵𝘦𝘢𝘮](http://t.me/Gukur_v)
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
⋄︙[𝘪𝘯𝘧𝘰𝘳𝘮𝘢𝘵𝘪𝘰𝘯 𝘊𝘜𝘒𝘜𝘙](https://t.me/o_vv_vv)
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'*⋄︙بواسطه ↫*['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'o_vv_vv')..') \n*⋄︙تم قفـل ↫ الدردشه*\n*⋄︙الايدي ↫* `'..msg.sender_user_id_..'`')
end,nil)   
...
function(arg,data) 
usertext = '\n*⋄︙المستخدم ↫* ['..data.first_name_..'](t.me/'..(data.username_ or 'o_vv_vv')..')'
...
usertext = '\n*⋄︙المستخدم ↫* ['..result.title_..'](t.me/'..(username or 'o_vv_vv')..')'
status  = '\n*⋄︙تم حظره عام من المجموعات*'
texts = usertext..status
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝘴𝘰𝘳𝘶𝘤𝘦 𝘊𝘜𝘒𝘜𝘙.',url="t.me/o_vv_vv"}},
}
local msg_id = msg.id_/2097152/0.5
...
{
{text = '𝘊𝘜𝘒𝘜𝘙 𝘊𝘏𝘈𝘕𝘕𝘌𝘓', url="t.me/o_vv_vv"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
