...
if DevHeDo(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/motel924/files_mote/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/motel924/files_mote/main/File_Bot/"..file)
if res == 200 then
