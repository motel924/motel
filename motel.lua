...
os.execute('wget https://raw.githubusercontent.com/DRAGON924/DRAGON/main/DRAGON.lua')
...
if name_MRHeDo then 
names_MRHeDo = database:smembers(bot_id.."DRAGON:blocname"..msg.chat_id_) or ""
...
if mrHeDo2.first_name_:match("(.*)"..database:get(bot_id.."DRAGON:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."DRAGON:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrHeDo_nnn = database:get(bot_id.."DRAGON:nump"..msg.chat_id_) or 5
local mrHeDo_nnn2 = database:get(bot_id.."DRAGON:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
