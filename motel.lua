...
sudo_users = {SUDO,833156404,1610281882}   
...
send(msg.chat_id_, msg.id_,'⌔∮تم تحديث السورس \n⌔∮لديك اخر اصدار لسورس موتيل\n⌔∮الاصدار -› { v 1.5}')
dofile('motel.lua')  
end
if text == 'الاصدار ⌔' and DevHeDo(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'⌔∮اصدار سورس موتيل \n⌔∮الاصدار -›{ v 1.5}')
end
...
if name_MRHeDo then 
names_MRHeDo = database:smembers(bot_id.."motel:blocname"..msg.chat_id_) or ""
...
if mrHeDo2.first_name_:match("(.*)"..database:get(bot_id.."motel:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."motel:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrHeDo_nnn = database:get(bot_id.."motel:nump"..msg.chat_id_) or 5
local mrHeDo_nnn2 = database:get(bot_id.."motel:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
𓍼 ⁝ MOTEL TEAM
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓍼 ⁝ [𝑺𝑶𝑼𝑹𝑼𝑪𝑬 𝑪𝑯𝑨𝑵𝑵𝑬𝑳](https://t.me/Vc33h) 

𓍼 ⁝ [𝒔𝒐𝒖𝒓𝒖𝒄𝒆 𝒇𝒊𝒍𝒆𝒔](https://t.me/Vc33h) 

𓍼 ⁝ [𝑻𝑾𝑺 𝑴𝑶𝑻𝑬𝑳](http://t.me/Z_A_XBOT) 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
𓍼 ⁝ [Mtwr](http://t.me/H_4_L ) 
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == 'الملفات' and DevHeDo(msg) then
t = '⌔∮ملفات السورس موتيل ↓\n ٴ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ٴ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevHeDo(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/motel924/Files_motel/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⌔∮اهلا بك في متجر ملفات موتيل\n⌔∮ملفات السورس ↓\nٴ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ٴ\n\n"
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevHeDo(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/motel924/Files_motel/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('motel.lua')  
else
send(msg.chat_id_, msg.id_,"⌔∮عذرا الملف لايدعم سورس موتيل \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevHeDo(msg) then
...
if text == "مسح الملفات" and DevHeDo(msg) then
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'موتيل').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'موتيل')
local motel_Msg = {
'عمغي 🥺💕.',
...
end --الكود حصري سورس موتيل يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'موتيل').." غادر" or text == 'بوت غادر' then  
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'موتيل')
