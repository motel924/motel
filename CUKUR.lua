...
os.execute('wget https://raw.githubusercontent.com/motel942/motel/main/CUKUR.lua')
...
os.execute('rm -rf CUKUR.lua')
os.execute('wget https://raw.githubusercontent.com/motel924/motel/main/CUKUR.lua')
send(msg.chat_id_, msg.id_,'⌔∮تم تحديث السورس \n⌔∮لديك اخر اصدار لسورس سوكر\n⌔∮الاصدار -› { v 1.5}')
dofile('CUKUR.lua')  
end
